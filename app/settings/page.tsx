...
export default function SettingsPage() {
  ...
  const handleReset = () => {
    ...
    localStorage.removeItem("trackify-dues");
  ...
  const handleClearSettledDues = () => {

    const confirmClear =
      confirm("Delete all settled dues history?");
    ...
    localStorage.setItem(
      "trackify-dues",
      JSON.stringify(activeDues)
    );

    alert("Settled dues history cleared");
  };
    ...
    <main className="min-h-screen text-white flex justify-center">
      ...
      <div className="w-full max-w-md px-5 py-6 pb-28 min-h-screen">
        ...
        <div className="space-y-4 mt-6">
          ...
          <button
            onClick={handleClearSettledDues}
            className="w-full bg-green-500/20 text-green-400 py-4 rounded-2xl font-medium"
          >
            Clear Settled Dues History
          </button>
